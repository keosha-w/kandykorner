...
export const Register = (props) => {
    ...
    const existingUserCheck = () => {
        return fetch(`http://localhost:8098/customers?email=${customer.email}`)
            .then(res => res.json())
    ...
    return (
        <main style={{ textAlign: "center" }}>
            ...
            <form className="form--login" onSubmit={handleRegister}>
                <h1 className="h3 mb-3 font-weight-normal">Please Register for Kandy Korner Confections</h1>
                <fieldset>
